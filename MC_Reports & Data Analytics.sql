...
SELECT
	...
	2) as coffee_cosumers_in_millions,
	city_rank
FROM city
ORDER BY 2 DESC
...
-- How many unique customers are there in each who have purchased coffee products?
...
-- Identify top 3 cities based on highest sales, return city name, total sale, total rent, total customers, estimated coffee consumers
